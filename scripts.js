let url="https://api.openweathermap.org/data/2.5/weather?appid=291d9dd0c98698aec173bbebdd656ecb&units=metric&q=thrissur"
// fetch(url).then(res=>res.json()).then(data=>console.log(data))

function fetchWeather(){
    let city=id_city.value
    fetch(`https://api.openweathermap.org/data/2.5/weather?appid=291d9dd0c98698aec173bbebdd656ecb&units=metric&q=${city}`)
...
function displayWeather(data){
    ...
    <div class="weatherInfo">
      <div class="temperature">${tem}</span></div>
